...
parser.add_argument("--dataset_dir", type=str, default="/home/bo/CMSC733/proj_4/SfMLearner/data/TrainingAndValData/", help="where the dataset is stored")
...
parser.add_argument("--dump_root", type=str, default="/home/bo/CMSC733/proj_4/SfMLearner/data/format/",help="Where to dump the data")
