...
class SfMLearner_modified(object):
    def __init__(self):
        pass
    ...
    def build_train_graph(self):
        ...
        with tf.name_scope("depth_prediction"):
            pred_disp, depth_net_endpoints = disp_net(tgt_image, 'vgg', True)
    ...
    # Refer: https://github.com/yzcjtr/GeoNet/blob/master/geonet_model.py
    def SSIM(self, x, y):
        C1 = 0.01 ** 2
        C2 = 0.03 ** 2
    ...
    def build_depth_test_graph(self):
        ...
        with tf.name_scope("depth_prediction"):
            pred_disp, depth_net_endpoints = disp_net(
                input_mc, 'vgg', is_training=False)
